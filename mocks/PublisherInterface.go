...
// NewPublisherInterface creates a new instance of PublisherInterface. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewPublisherInterface(t testing.TB) *PublisherInterface {
